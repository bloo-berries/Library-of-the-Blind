...
### Multimodal Systems
- **Count:** 1 per unique pairing
- **Examples:** 
  - Screen-reader + Braille (English)
  - Pro-Tactile + STT (American Sign Language)
...
- Each distinct Braille code counts as a separate "language entry" because it requires its own translation tables, teaching materials, and publishing pipelines.
