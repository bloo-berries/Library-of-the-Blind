...
- [Asian & Pacific](asian/) - Braille codes for Asian languages and scripts
- [European](european/) - Braille codes for European languages
- [Specialized](specialized/) - Music, Mathematics, Computer Braille, and other specialized codes

## Overview

Each Braille system represents a distinct code that requires:
- Unique translation tables
- Language-specific teaching materials
